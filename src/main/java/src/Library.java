...
public class Library {
    ...
    public JTextField bookInput = new JTextField(20);
    public JTextField authorInput = new JTextField(20);
    public JTextField isbnInput = new JTextField(20);
    public JComboBox bookCondition = new JComboBox(Book.CONDITION.values());
